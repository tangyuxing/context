function [res_test, res_train] = rcnn_exp_train_context_and_test()
...
if k_folds > 0
  res_train = rcnn_test_context(rcnn_k_fold_model, imdb_train);
else
  res_train = [];
end

res_test = rcnn_test_context(rcnn_model, imdb_test);
